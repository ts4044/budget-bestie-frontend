...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://conqbhdwi5.execute-api.us-east-1.amazonaws.com/v1';
    ...
    apigClient.receiptsUploadPost = function (params, body, additionalParams) {
        ...
        var receiptsUploadPostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/receipts/upload').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(receiptsUploadPostRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.receiptsUploadOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var receiptsUploadOptionsRequest = {
